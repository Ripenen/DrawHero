...
public class PrefabCreator : MonoBehaviour
{
    ...
    public string standartMaterialPath = "Assets/AssetPacks/HYPERCASUAL - Stickman Customization/MaterialsCreator/";
    ...
    {
        bool result = false;
        PrefabUtility.SaveAsPrefabAsset(_objForSave, "Assets/AssetPacks/HYPERCASUAL - Stickman Customization/PrefabCreator/" + _objForSave.name + ".prefab", out result);
        Destroy(_objForSave);
    }
